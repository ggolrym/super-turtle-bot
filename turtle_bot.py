# ==========================================
# 🐢 AI 하이브리드 터틀 봇 V15.2 (실전 인프라 + 자본금 50만원 최적화)
# ==========================================
import os
...
KIS_URL = "https://openapi.koreainvestment.com:9443" # 실전투자 URL
...
# ==========================================
TOTAL_CAPITAL = 500000      # 👇 50만 원으로 복구
RISK_PERCENT = 0.02        
RISK_AMOUNT = TOTAL_CAPITAL * RISK_PERCENT

MIN_TURNOVER_KRW = 5000000000      # 코스피 50억 유지
KOSDAQ_MIN_TURNOVER = 3000000000   # 코스닥 30억 유지
MIN_MARKET_CAP_KRW = 100000000000 
MIN_PRICE_KRW = 1000               # 1000원 이상 유지

MAX_POSITIONS = 4           # 👇 한국 2개 / 미국 2개 총 4개 슬롯
MAX_KR_POSITIONS = 2        
MAX_US_POSITIONS = 2        
MAX_SECTOR_POSITIONS = 2       
MAX_POSITION_KRW = 150000   # 👇 종목당 최대 15만 원 진입
